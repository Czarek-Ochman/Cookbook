...
insert into recipe (category, description, title, user_id,img) values (
'DRINK', 'Dla uzyskania klarownego płynu cocktail można przecedzić przez podwójne sitko. Pyszny domowy drink gotowy!', 'Lime Basil Smash', 1,'https://cdn.pixabay.com/photo/2016/10/22/20/09/white-wine-1761575_960_720.jpg');
...
insert into recipe (category, description, title, user_id,img) values (
'DRINK', 'Gotowanie kakao to niezwykle trudna sztuka. Nie mamy na myśli kakao rozpuszczalnego, gdzie wystarczy wrzucić dwie łyżeczki proszku, zalać wodą albo gorącym mlekiem.', 'Kakao', 3, 'https://cdn.pixabay.com/photo/2016/10/30/09/30/hot-chocolate-1782623_960_720.jpg');
...
insert into recipe (category, description, title, user_id,img) values (
'DRINK', 'Napewno wiele osób uwielbia słodkie mleko, teraz możecie sami je zrobić', 'Słodkie Mleko!', 1, 'https://cdn.pixabay.com/photo/2017/07/05/15/41/milk-2474993_960_720.jpg');
...
insert into recipe (category, description, title, user_id,img) values (
'DRINK', 'Rozgrzewa, pobudza zmysły (szczególnie to z goździkami) i poprawia nastrój! Sięgaj po nie, kiedy przemarzłaś, a szybko wrócisz do formy. Grzane wino pomoże ci też w przeziębieniu.', 'Grzane wino', 1,'https://www.pieknowdomu.pl/wordpress/wp-content/uploads/2018/01/grzane-wino-01.jpg');
...
insert into recipe (category, description, title, user_id,img) values (
'BREAKFAST', 'Idealna na śniadanie!', 'Jajecznica ze szczypiorkiem', 1,'https://cdn.pixabay.com/photo/2015/08/05/12/29/breakfast-876432_960_720.jpg');
...
insert into recipe (category, description, title, user_id,img) values (
'BREAKFAST', 'Szybkie, smaczne idealne dla twojej 2 połówki!', 'Naleśniki z malinami', 2,'https://cdn.pixabay.com/photo/2017/05/07/08/56/pancakes-2291908_960_720.jpg');
...
insert into recipe (category, description, title, user_id,img) values (
'BREAKFAST', 'Lekkie, mało kaloryczne i do tego apetyczne', 'Jogurt z owocami', 3,'https://cdn.pixabay.com/photo/2016/06/07/17/15/yogurt-1442034_960_720.jpg');
...
insert into recipe (category, description, title, user_id,img) values (
'BREAKFAST', 'Bomba witaminowa, polecamy wszystkim!', 'Witaminowe BUM', 4,'https://cdn.pixabay.com/photo/2016/02/19/10/29/breakfast-1209260_960_720.jpg');
...
insert into recipe (category, description, title, user_id,img) values (
'BREAKFAST', 'Coś dla leniuchów', 'Płatki z mlekiem', 5,'https://cdn.pixabay.com/photo/2016/06/08/19/46/cereal-1444495_960_720.jpg');
...
insert into recipe (category, description, title, user_id,img) values (
'DINNER', 'Dla smakoszy zup', 'LECZO Z BATATAMI', 6,'https://www.kwestiasmaku.com/sites/v123.kwestiasmaku.com/files/styles/kafelki/public/leczo_z_chorizo_batatami_00.jpg?itok=7_JjkxPY');
...
insert into recipe (category, description, title, user_id,img) values (
'DINNER', 'Idelane dla dzieci', 'Makaron na słodko', 7,'https://www.kwestiasmaku.com/sites/v123.kwestiasmaku.com/files/styles/kafelki/public/makaron_z_truskawkami_00.jpg?itok=FCj10kAc');
...
insert into recipe (category, description, title, user_id,img) values (
'DINNER', 'Tym zaskoczysz teścia!', 'Szybki żurek', 7,'https://www.kwestiasmaku.com/sites/v123.kwestiasmaku.com/files/styles/kafelki/public/zurek_blyskawiczny_00.jpg?itok=5ruHyB12');
...
insert into recipe (category, description, title, user_id,img) values (
'DINNER', 'Ciekawy smak, musisz spróbować!', 'Zupa Dyniowa', 9,'https://cdn.pixabay.com/photo/2017/11/23/13/50/pumpkin-soup-2972858_960_720.jpg');
...
insert into recipe (category, description, title, user_id,img) values (
'DINNER', 'Wyrazisty smak, lekka nuta cytryny', 'Zupa pomidorowa', 10,'https://cdn.pixabay.com/photo/2015/02/03/16/31/soup-622737__340.jpg');
...
insert into recipe (category, description, title, user_id,img) values (
'SUPPER', 'Wyrazisty smak, lekka nuta cytryny', 'Zupa pomidorowa', 10,'https://cdn.pixabay.com/photo/2015/02/03/16/31/soup-622737__340.jpg');
insert into ingredient (amount, name,recipe_id) values ('2l', 'bulion z kury', 15);
insert into ingredient (amount, name,recipe_id) values ('200g', 'koncentrat pomidorowy', 15);
insert into ingredient (amount, name,recipe_id) values ('1 łyżeczka', 'pieprz', 15);
insert into ingredient (amount, name,recipe_id) values ('250ml', 'śmietana 18%', 15);
